    ...
    <Container>
      <Row>
        <Col md={12} style={{border:'double', borderColor:'darkgray', borderRadius:'5px',margin:'5px'}}>
            <img src="src\assets\img\imagen Carla I. 2bis.jpg" alt="carla1.bis" className='d-block w-100 mb-3'/>
        ...
        <Col md={12} style={{border:'double', borderColor:'darkgray', borderRadius:'5px',margin:'5px'}}>
        <img src="src\assets\img\imagen Carla I.bis.jpg" alt="carla1" className='d-block w-100 mb-3'/>
